...
{% hint style="info" %}
The cfg element specifies the robot configuration. For more information, refer to "[2.3.2.2 Base and Robot Recording Coordinates](https://hrbook-asoe72.web.app/#/view/doc-hi6-operation/master/2-operation/2-3-step/step-pose-modify/base-robot-crd-sys)" in the Hi6 Robot Controller Operation Manual.
{% endhint %}
